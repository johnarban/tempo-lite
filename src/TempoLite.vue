      ...
      <div id="map-container">
        ...
        <div id="la-fires">
          ...
          <cds-dialog title="Extreme Events" v-model="showLADialog" :color="accentColor2">
            <v-row>
              <v-col>
            The high levels of smoke and pollution generated by the fires saturates the default
            ...
            color stretch for the duration of, for example, the Los Angeles fire outbreak. 
