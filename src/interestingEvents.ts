...
export const interestingEvents = [
  {
    ...
    <p>
      ...
      helping scientists and the public to understand the extent of the pollution. 
    </p>
    `,
    locations: [
      {
        ...
        <p>
          ...
          fires in the Los Angeles Area. On this day, the plumes are being blown
          by the window over the Pacific Ocean. 
          </p>
          <p>
          The Dark colors indicate very high levels of NO<sub>2</sub> and thus very
          poor air quality. 
          </p>
        `
      }]
